...
\\end{{document}}
"""
    with open("Subsidy_report_Rajasthan.tex", "w", encoding="utf-8") as f:
        f.write(tex_content)

    # Compile to PDF
    os.system("pdflatex -interaction=nonstopmode Subsidy_report_Rajasthan.tex")
    return "Subsidy_report_Rajasthan.pdf"
