...
which comes to {result['sgst_reimbursement']} payable over {zone_data["SGST Initial Years"]+zone_data["SGST Extended Years"]} years 
...
\\hline
Interest subsidy & Rs. {result['interest_subsidy']} & 7  & Post production \\\\
\\hline
SGST reimbursement & Rs. {result['sgst_reimbursement']} & 7 & Paid from cash ledger \\\\
\\hline
\\end{{longtable}}
